...
class DrugstoreController {
  ...
  /**
   * Render a form to be used for creating a new drugstore.
   * GET drugstores/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing drugstore.
   * GET drugstores/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Update drugstore details.
   * PUT or PATCH drugstores/:id
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
